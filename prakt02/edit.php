...
<html lang="en">
  ...
  <body>
    ...
    Jenis Kelamin
    <br>
    <label><input type="radio" name="jk" value="Laki - laki" <?php if($row['jenis_kelamin']=='Laki - laki') echo 'checked'?>>Laki - laki</label> 
    <label><input type="radio" name="jk" value="Perempuan" <?php if($row['jenis_kelamin']=='Perempuan') echo 'checked'?>>Perempuan</label>
